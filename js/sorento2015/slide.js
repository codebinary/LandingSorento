...
j(document).on('ready', function(){
  ...
  if( j('#home-main-slide3').length ){

    carouselSlider.slidePreloader('#home-main-slide3', '#thumbnails-slide3', '#section-slide3');

  }



  if( j('#home-main-slide4').length ){

    carouselSlider.slidePreloader('#home-main-slide4', '#thumbnails-slide4', '#section-slide4');

  }



  if( j('#home-main-slide5').length ){

    carouselSlider.slidePreloader('#home-main-slide5', '#thumbnails-slide5', '#section-slide5');

  }



  if( j('#home-main-slide6').length ){

    carouselSlider.slidePreloader('#home-main-slide6', '#thumbnails-slide6', '#section-slide6');
